...
export const AdminPanel: React.FC<AdminPanelProps> = ({ settings, onSettingsUpdated }) => {
  ...
  return (
    <div className="space-y-6">
      ...
      {activeTab === 'settings' && (
        <form onSubmit={handleSaveSettings} className="bg-slate-900 border border-slate-800 rounded-2xl p-6 shadow-2xl space-y-6">
          <div className="border-b border-slate-800 pb-3 flex items-center justify-between">
            ...
            <button
              ...
              className="flex items-center space-x-2 px-5 py-2 bg-blue-600 hover:bg-blue-500 text-white font-bold text-xs rounded-xl shadow-lg shadow-blue-600/30"
            >
